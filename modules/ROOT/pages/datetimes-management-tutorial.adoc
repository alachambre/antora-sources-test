...
NOTE: This howto applies to Bonita 7.5.0 and above.
...
NOTE: The Date picker widget supports the following types for its *Value* property as input:
...
NOTE: The *Date time picker* widget output is an https://en.wikipedia.org/wiki/ISO_8601[ISO 8601] formatted String (e.g.
"2017-01-13T15:00:00").
...
NOTE: The *Date time picker* widget output is an https://en.wikipedia.org/wiki/ISO_8601[ISO 8601] formatted String representing the selected date and time in UTC (e.g.
