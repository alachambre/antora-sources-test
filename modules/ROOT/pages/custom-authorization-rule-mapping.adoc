...
NOTE: You can find a complete implementation example of page mapping authorization rule and configuration in https://github.com/bonitasoft/bonita-page-authorization-rules[this project on GitHub].
